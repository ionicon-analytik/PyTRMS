...
while True:
    ...
    filename = time.strftime("RepCal_%Y-%m-%d_%H-%M-%S", time.localtime())
    ...
    client.set('OP_Mode', myPTRSET_BK)
    time.sleep(60) # to flush
    print('Waiting 25 min to go')
    time.sleep(300) # to flush
    print('Waiting 20 min to go')
    time.sleep(300) # to flush
    print('Waiting 15 min to go')
    time.sleep(300) # to flush
    print('Waiting 10 min to go')
    time.sleep(300) # to flush
    print('Waiting 05 min to go')
    time.sleep(300) # to flush
